...
@AllArgsConstructor
public class UserCreatedAddPermissionToCreateProjectsMsgListener implements AggregateEventMessageListener {
    ...
    public Mono<Void> onMessage(AggregateEventMessage message) {
        ...
        return permissionsFacade.addPermissionToCreateProjectsForNewUser(userId);
    }
